...
class Ui_log_window(object):
    def setupUi(self, log_window):
        ...
        self.layoutWidget = QtWidgets.QWidget(log_window)
        self.layoutWidget.setGeometry(QtCore.QRect(30, 20, 541, 411))
        ...
        self.btn_export = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
