...
class Ui_save_key(object):
    def setupUi(self, save_key):
        ...
        save_key.resize(414, 238)
        save_key.setMinimumSize(QtCore.QSize(414, 238))
        save_key.setMaximumSize(QtCore.QSize(414, 238))
        self.layoutWidget = QtWidgets.QWidget(save_key)
        self.layoutWidget.setGeometry(QtCore.QRect(-10, 10, 431, 231))
